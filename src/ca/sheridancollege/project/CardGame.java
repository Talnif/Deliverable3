...
public class CardGame {
    ...
    public void start() {
        ...
        while (!playerHand.isEmpty() && !computerHand.isEmpty()) {
            ...
            System.out.println("Do you want to quit the game? 0 for no, 1 for yes. <0/1> ");
            int quitOption = scanner.nextInt();
            
            // Option to stop or continue with the game
            switch (quitOption) {
                case 0:
            ...
            // Only proceed if the deck is not cleared from quitting
            // Without the condition the game would continue with a negative deck and results in an error
